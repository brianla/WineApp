...
def inputLogin(email, password):
  ...
  Args:
    string email: The potential email
...
def inputEditUser(user, attr):
  ...
  Return:
    UserInfo: UserInfo object representing the edited user.
  """
...
def inputDeleteUser(user):
  ...
  Return:
    UserInfo: UserInfo object representing the deleted user
  """
  return deleteUser(user)


def verifyUser(dictUser):
  """Make sure the dictionary representing a user is valid, and create a UserInfo object if it is.
  
  Args:
    dict dictUser: Dictionary holding the fields of a real UserInfo object.
    
  Return:
    UserInfo: UserInfo object representing the user if valid
  """
