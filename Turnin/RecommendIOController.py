...
def inputGetSeeds(recommenderID):
  """ Returns the list of seeds for a particular recommender"""
...
def inputEditChannel(recommenderID, channelName):
  ...
  Return:
    Recommender: The recommender object representing the channel modified
  """
...
def inputRemoveChannel(recommenderID):
  ...
  Return: 
    Recommender: The recommender object representing the channel removed
  """
  err = []
...
def inputAddSeeds(recommenderID, seeds):
  ...
  Return:
    recommender: The Recommender object we added seeds to.
  """
  err = []
...
def inputRemoveSeeds(recommenderID, seeds):
  ...
  Return:
    recommender: The Recommender object we removed seeds from.
  """
  err = []
...
def inputRecommend(recommenderID, numOfWines):
  ...
  Args:
    int recommenderID: the ID of the recommender object 
    int numOfWines: the number of wines to recommend
  Return:
    list: A list of the wine IDs of the recommended wines
  """ 
  err = []
  if DEBUG:
